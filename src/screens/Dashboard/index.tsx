    ...
    async function loadTransaction() {
        ...
        setHighlightData({
            ...
            expensives: {
                ...
                lasTransaction : `Última saída dia ${lastTransactionExpensives}`
            },
            total: {
                ...
                isLoading ?
                    ...
                    <>
                        <Header>
                            <UserWrapper>
                                <UserInfo>
                                    <Photo source={{ uri: 'https://avatars.githubusercontent.com/u/83524305?v=4' }} />
                                    <User>
                                        <UserGreeting>Olá, </UserGreeting>
                                        <UserName>Raphael Furtado</UserName>
                                    </User>
                                </UserInfo>
                        ...
                        <HighlightCards>
                            ...
                            <HighlightCard
                                ...
                                lastTransaction={highlightData.expensives.lasTransaction}
                            />
                            <HighlightCard
                                type='total'
                                title='Total'
